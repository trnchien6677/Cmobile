...
<body>
	...
	<div class="super_container">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-2 order-lg-1 order-2">
						<ul class="image_list">
							<li data-image="${pageContext.request.contextPath }/images/single_4.jpg"><img
								src="../resources/images/${product.getImage()}" alt=""></li>
							<li data-image="${pageContext.request.contextPath }/images/single_2.jpg"><img
								src="../resources/images/${product.getImage()}" alt=""></li>
							<li data-image="${pageContext.request.contextPath }/images/single_3.jpg"><img
								src="../resources/images/${product.getImage()}" alt=""></li>
						</ul>
					</div>
							...
							<div class="order_info d-flex flex-row">
								<form action="#">
									...
									<div class="product_price">
										<fmt:formatNumber value="${product.getPrice()}" type="number" maxIntegerDigits="14" />vnd
									</div>
		...
		<jsp:include page="../home/lq.jsp"></jsp:include>
		<!-- Footer -->
